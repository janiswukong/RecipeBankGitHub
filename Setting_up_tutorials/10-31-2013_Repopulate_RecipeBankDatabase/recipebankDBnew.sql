...
CREATE TABLE `recipecategory` (
  ...
  CONSTRAINT `fk_recipecatagory_CatagoryId` FOREIGN KEY (`CatagoryId`) REFERENCES `category` (`CategoryId`) ON DELETE CASCADE ON UPDATE CASCADE,
...
-- Dump completed on 2013-11-01  2:08:14
